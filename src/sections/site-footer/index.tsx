...
const contactDetails = [
  {
    ...
    value: "0908 607 391",
    href: "tel:0908607391",
    secondaryValue: "0972 111 329",
    secondaryHref: "tel:0972111329",
  },
  {
    icon: Mail,
    label: "Email",
  ...
  return (
    <footer id="lien-he" className="bg-cream-mid">
      <div className="mx-auto grid max-w-[1440px] gap-6 px-5 py-[52px] sm:px-8 lg:grid-cols-[minmax(0,820px)_380px] lg:gap-20 lg:px-20 lg:py-16">
        <div>
          <p className="text-[12px] font-bold tracking-[0.16em] text-ember-dark lg:hidden">
            LIÊN HỆ ĐẶT HÀNG
          </p>
          <h2 className="hidden font-display text-[42px] font-bold tracking-[0.075em] text-coal-dark lg:block">
            Liên hệ đặt hàng
          </h2>
          <h3 className="mt-1 font-display text-[32px] font-semibold leading-[1.08] text-ember-dark lg:mt-4 lg:font-normal">
            Nhận phương án cung ứng trong 30 phút
          </h3>
          <p className="mt-2 max-w-[820px] text-[15px] leading-[1.5] text-text-muted lg:mt-4">
            Cho chúng tôi biết loại lò, sản lượng và lịch giao dự kiến. Đội ngũ
            sẽ tư vấn loại than và báo giá phù hợp.
          </p>
          <p className="mt-6 hidden max-w-[460px] text-[17px] leading-[1.6] text-text-muted lg:block">
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-coal-dark">
                      <strong className="block text-[11px] font-light leading-[1.2] text-ember-dark lg:inline lg:text-base lg:leading-normal">
                        {label}
                        <span className="hidden lg:inline">:</span>
                      </strong>{" "}
                      <span className="block text-base leading-[1.4] lg:inline lg:text-lg lg:leading-normal">
                        {contactValue}
                      </span>
                    </p>
                  </div>
        ...
        <aside className="flex min-h-[196px] flex-col items-center justify-center rounded-[4px] border border-border bg-white px-[22px] py-[26px] text-center lg:min-h-[299px] lg:rounded-md lg:px-7 lg:py-10">
          <h3 className="font-display text-[29px] font-medium leading-tight text-coal-dark lg:text-[42px] lg:font-light">
            Sẵn sàng đặt hàng?
          </h3>
          <p className="mt-2 max-w-[306px] text-sm leading-[1.5] text-text-muted lg:mt-4 lg:max-w-[300px] lg:text-base lg:leading-[1.6]">
            Gọi ngay hoặc gửi thông tin. Đội ngũ Than Đá Thái Bình sẽ phản hồi
            trong 30 phút với báo giá chi tiết.
          </p>
          <a
            href="tel:0908607391"
            className="mt-3 flex h-12 w-full items-center justify-center gap-2 rounded-sm bg-ember-gold px-6 text-sm font-bold tracking-[0.05em] text-coal-black transition-colors hover:bg-ember-light lg:mt-5 lg:h-16 lg:text-3xl lg:font-light lg:tracking-normal"
          >
      ...
      <div className="border-t border-border bg-border py-14">
        <div className="mx-auto flex h-[104px] max-w-[1440px] flex-col items-center px-5 pt-[18px] sm:px-8 lg:h-16 lg:flex-row lg:justify-between lg:px-20 lg:pt-0">
          <BrandLogo />
          <p className="mt-2 text-[12px] font-semibold text-text-muted lg:mt-0 lg:text-sm lg:tracking-wide">
            Power of TexCra
          </p>
        </div>
      </div>

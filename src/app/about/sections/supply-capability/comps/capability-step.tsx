...
export function CapabilityStep({
  ...
  return (
    <article className="grid grid-cols-[28px_minmax(0,1fr)] border-t border-white/15 py-5 lg:grid-cols-[1fr_auto] lg:border-l lg:px-8 lg:py-[26px] lg:first:border-l-0">
      <span className="row-span-4 pt-5 font-display text-[15px] font-bold text-ember-light lg:row-auto lg:pt-0 lg:text-sm lg:font-semibold">
        {index}
      </span>
      ...
      <p className="col-start-2 mt-1 text-[9px] font-semibold leading-[1.3] text-ember-light lg:col-span-2 lg:col-start-1 lg:mt-7 lg:text-[11px] lg:leading-[1.5]">
        {note}
      </p>
    </article>
  );

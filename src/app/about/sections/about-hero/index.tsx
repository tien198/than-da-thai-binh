...
export function AboutHero() {
  return (
    ...
    >
      <div className="relative mx-auto h-full max-w-[1440px] overflow-hidden">
        <div className="absolute inset-0 lg:left-[38.8889%]">
          <Image
        ...
        <div className="absolute inset-x-5 top-16 lg:left-20 lg:right-auto lg:top-[76px] lg:w-[650px]">
          <div className="mb-3 h-0.5 w-[42px] bg-ember-light lg:mb-0 lg:hidden" />
          <div className="flex items-center gap-3">
            <span className="hidden h-px w-9 bg-ember-light lg:block" />
            <p className="text-[9px] font-bold leading-none tracking-[0.17em] text-ember-light lg:text-xs lg:tracking-[0.25em]">
              VỀ CHÚNG TÔI
            </p>
          </div>
          ...
          <h1
            id="about-hero-title"
            className="mt-3 font-display text-[38px] font-semibold leading-[0.98] tracking-[-0.025em] lg:mt-5 lg:text-[58px] lg:leading-[1.03]"
          >
            Công ty TNHH
            <br />
            Than Đá Thái Bình
          ...
          <p className="mt-3 font-display text-sm leading-[1.35] text-ember-light lg:mt-5 lg:font-body lg:text-lg lg:font-semibold">

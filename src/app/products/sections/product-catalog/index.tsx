    ...
    <>
      ...
      >
        <div className="mx-auto max-w-[1440px] px-5 pt-[52px] pb-9 sm:px-8 lg:px-20 lg:pt-[72px] lg:pb-[52px]">
          <p className="text-[10px] font-bold tracking-[0.18em] text-brand-flame">
            05 DÒNG THAN ĐÁ
          </p>
          <h2
            id="product-catalog-title"
            className="mt-2 max-w-[780px] font-display text-[32px] leading-[1.08] text-coal-dark lg:text-[40px] lg:leading-[43px]"
          >
            Một lựa chọn rõ ràng cho từng bài toán đốt.
          </h2>
          <p className="mt-2 max-w-[720px] text-[13px] leading-5 text-text-muted lg:text-sm lg:leading-[21px]">

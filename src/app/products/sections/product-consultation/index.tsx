  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-[1440px] gap-8 px-5 py-[52px] sm:px-8 lg:grid-cols-[minmax(0,1fr)_430px] lg:items-center lg:gap-20 lg:px-20 lg:py-16">
        <div>
          <p className="text-[12px] font-bold tracking-[0.16em] text-brand-flame">
            CHƯA CHẮC LOẠI NÀO PHÙ HỢP?
          </p>
          <h2
            id="product-consultation-title"
            className="mt-3 max-w-[650px] font-display text-[34px] leading-[1.08] lg:text-[42px] lg:leading-[43px]"
          >
            Gửi 3 thông tin. Nhận đúng phương án than đá.
          </h2>
          <p className="mt-3.5 max-w-[650px] text-[15px] leading-5 text-[#c9c1b6] lg:text-base lg:leading-[22px]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href="#lien-he"
            className="flex items-center justify-center gap-2.5 rounded-sm bg-brand-flame px-[18px] py-[15px] text-[13px] font-bold tracking-[0.07em] transition-colors hover:bg-ember-dark"
          >
